   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="modal fade" id="largeModalImport" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h3 class="modal-title" id="myModalLabel">Import Data Supplier</h3>
            </div>

            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url().'admin/controler_global/import/supplier'?>">
                <div class="modal-body">

                    <div class="col-xs-12 content-center">
                        Download Template SUPPLIER Disini !
                        <a href="<?php echo base_url().'assets/template_excel/supplier_template.xls'?>" download>Template Excel</a>
                    </div>
